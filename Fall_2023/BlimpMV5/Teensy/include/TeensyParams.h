...
// #define BLIMP_ID           "Yoshi"      // Publish ID of blimp - type: String
#define BLIMP_ID           "Geoph"      // Publish ID of blimp - type: String
// #define BLIMP_ID           "ThisGuy"      // Publish ID of blimp - type: String
